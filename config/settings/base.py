...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres:///rss_reader")
}
...
LOCAL_APPS = [
    ...
    "rss_reader.feeds.apps.FeedsConfig"
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "rss_reader.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Jean Luis Lopez""", "jeanluis.jl19@gmail.com")]
